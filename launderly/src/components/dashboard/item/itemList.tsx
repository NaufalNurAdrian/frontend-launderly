          ...
          <table className="w-full">
            <thead>
              <tr className="bg-blue-50">
                <th className="font-semibold text-blue-900 px-4 py-3 text-left">Item Name</th>
                <th className="font-semibold text-blue-900 px-4 py-3 text-right">Created Date</th>
                <th className="font-semibold text-blue-900 px-4 py-3 text-right">Updated Date</th>
                <th className="font-semibold text-blue-900 px-4 py-3 text-right">Actions</th>
              </tr>
            </thead>
            <tbody>
              {items.map((item) => (
