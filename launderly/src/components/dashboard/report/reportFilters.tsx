...
const ReportFilters: React.FC<ReportFiltersProps> = ({
  ...
  useEffect(() => {
    ...
    if (!isDirty && JSON.stringify(dateRange) !== JSON.stringify(prevPropsRef.current.dateRange)) {
    ...
    if (timeframe !== prevPropsRef.current.timeframe) {
      ...
      if (prevPropsRef.current.timeframe === "custom" && timeframe !== "custom") {
  ...
  return (
    <Card className="bg-white border border-gray-100 shadow-sm mb-6 transition-all hover:shadow-md overflow-hidden">
      ...
      <CardContent className="p-4">
        <div className={`grid gap-4 ${isSuperAdmin ? 'md:grid-cols-2' : 'md:grid-cols-2 lg:grid-cols-3'}`}>
          {isSuperAdmin && (
            <div className="space-y-1">
              ...
              >
                ...
                <SelectContent className="max-h-60">
                  <SelectItem value="all" className="hover:bg-blue-50">All Outlets</SelectItem>
          ...
          <div className="space-y-1">
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="daily" className="hover:bg-blue-50">Daily</SelectItem>
                <SelectItem value="weekly" className="hover:bg-blue-50">Weekly</SelectItem>
          ...
          <div className="space-y-1">
            ...
            <DatePickerWithRange
              ...
              className={`w-full h-9 ${timeframe !== "custom" ? "opacity-70" : ""}`}
            />
          </div>
        </div>
      </CardContent>
