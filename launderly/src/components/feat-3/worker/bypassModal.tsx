  ...
  return (
    <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-[400px] mx-1">
        ...
        <textarea value={bypassNotes} onChange={(e) => setBypassNotes(e.target.value)} className="w-full p-2 border bg-white border-blue-300 rounded-md mb-4" rows={4} placeholder="Add your notes here..." />
