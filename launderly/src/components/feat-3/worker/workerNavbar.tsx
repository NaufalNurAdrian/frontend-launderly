...
export default function Navbar() {
  ...
  const navItems = [
    { name: "Attendance", path: "/worker/attendance", icon: <CalendarCheck size={24} /> },
    { name: "Notifications", path: "/worker/notifications", icon: <Bell size={24} /> },
    { name: "Requests", path: "/worker/requests", icon: <FileText size={24} /> },
    { name: "History", path: "/worker/history", icon: <FolderClock size={24} /> },
  ];
